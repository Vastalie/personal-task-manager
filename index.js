...
// Spotify initialization function
    ...
    app.get('/', async (req, res) => {
      try {
        ...
        if (spotifyApi.getAccessToken()) {
          try {
            const response = await spotifyApi.getPlaylist('4mIRypXv49j37pEJNuaZ46');
            playlistData = {
            ...
            console.error('Error fetching playlist:', spotifyError);
          }
        }
        ...
        res.render('index', { 
          ...
          error: !playlistData ? 'Unable to fetch Spotify playlist. Please try again later.' : null
        });
      } catch (err) {
